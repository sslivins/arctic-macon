...
// AP13 "Highest setting temperature of hot water, heating mode" (20~55 °C,
...
constexpr uint16_t REG_HOT_WATER_CEILING    = 2012;  // AP13 max hot-water temp (ceiling, not live setpoint)
