...
| `arctic_registers.{h,cpp}` | Macon register numbering, per-register metadata (name/unit/scale/signed), value + bitmap formatting, `register_lookup()`. |
...
and `#include "tuya_codec.h"`, `#include "arctic_registers.h"`,
